<form action="/join-us/ca" method="POST">
    @csrf
        ...
        <div>  
            ...
            <div class="flex py-2.5">
                <div class="flex items-center mr-4">
                    <input checked id="male" type="radio" value="male" name="gender" class="w-4 h-4 text-gray-600 color-2 bg-gray-100 border-gray-300 focus:ring-gray-500 accent-current">
    ...
    <div class="mb-6">
        <label for="company" class="block mb-2 text-sm font-medium text-gray-900">Company (Interested for Ambassador)</label>
