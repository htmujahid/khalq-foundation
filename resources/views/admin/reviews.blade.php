<x-app-layout class="">    
    <div class="flex flex-col md:flex-row justify-center items-center gap-6 mt-6">
        <div>  
            <a href="">
                <button id="" class="button text-center border py-2 px-4 rounded-md shadow color-2">Reviews</button>
            </a>
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr class="bg-white  hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 text-right">
                        {{ Form::open(array('route' => array('reviews.edit', $item->id), 'method' => 'get', 'class'=>'inline')) }}
                            <button type="submit" >Edit</button>
                        {{ Form::close() }}
                        | 
                        {{ Form::open(array('route' => array('reviews.destroy', $item->id), 'method' => 'delete', 'class'=>'inline')) }}
