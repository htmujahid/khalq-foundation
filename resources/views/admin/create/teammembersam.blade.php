<x-app-layout class="">    
    <div class="flex flex-col md:flex-row justify-center items-center gap-6 mt-6">
        <div>  
            <a href="">
                <button id="" class="button text-center border py-2 px-4 rounded-md shadow color-2">Add Area Manager</button>
            </a>
        </div>
    </div>
    <div class="relative overflow-x-scroll scroll shadow-md sm:rounded-lg px-6">
        <form action="/admin/team-members/am" method="POST">
            @csrf
            ...
            <div class="mb-6">
                <label for="area" class="block mb-2 text-sm font-medium text-gray-900">Area (interested for Area Manager)</label>
                <textarea id="area" name="area" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-gray-500 focus:border-gray-500" placeholder=""></textarea>
            </div>
