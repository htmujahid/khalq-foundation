<x-app-layout class="">    
    <div class="flex flex-col md:flex-row justify-center items-center gap-6 mt-6">
        <div>  
            <a href="">
                <button id="" class="button text-center border py-2 px-4 rounded-md shadow color-2">Case Donations</button>
            </a>
        </div>
    </div>
    <div class="relative overflow-x-scroll scroll shadow-md sm:rounded-lg ">
        <div class="flex">
            ...
            <div class="p-4">
                <a href="/admin/case-donations/create">
                    <label for="table-search" class="sr-only">Search</label>
                    <div class="mt-1">
            ...
            <tbody>
                ...
                <tr class="bg-white  hover:bg-gray-50">
                    ...
                    <td class="px-6 py-4 text-right">
                        {{ Form::open(array('route' => array('case-donations.edit', $item->id), 'method' => 'get', 'class'=>'inline')) }}
                            <button type="submit" >Edit</button>
                        {{ Form::close() }}
                        | 
                        {{ Form::open(array('route' => array('case-donations.destroy', $item->id), 'method' => 'delete', 'class'=>'inline')) }}
